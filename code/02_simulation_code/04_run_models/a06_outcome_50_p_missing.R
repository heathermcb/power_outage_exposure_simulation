...
result_1p <- parLapply(
  ...
  response_col = 'hosp_count_1_p_50_p_missing',
  offset_col = 'n'
)
...
result_5p <- parLapply(
  ...
  fun = run_poisson_model,
  predictor_col = 'exposed_none_missing',
  response_col = 'hosp_count_5_p_50_p_missing',
  offset_col = 'n'
)
...
result_0.5p <- parLapply(
  ...
  fun = run_poisson_model,
  predictor_col = 'exposed_none_missing',
  response_col = 'hosp_count_0.5_p_50_p_missing',
  offset_col = 'n'
)
...
saveRDS(
  ...
  here(
    ...
    "50_p_missing_models_beta_CIs_1p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "50_p_missing_models_beta_CIs_5p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "50_p_missing_models_beta_CIs_05p.RDS"
  )
)
...
ls_2 <- list.files(
  ...
  pattern = "^outcome_data_8_hrs_50_p_missing",
  full.names = T
)
...
colnames(results_cc_df_05) <-
  c(
    "beta_50_p_missing_model_05p_cc",
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "50_p_missing_models_case_crossover_beta_CIs_05p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "50_p_missing_models_case_crossover_beta_CIs_1p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "50_p_missing_models_case_crossover_beta_CIs_5p.RDS"
  )
)

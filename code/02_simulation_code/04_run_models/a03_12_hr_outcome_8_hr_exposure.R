# This script will run models in a misclassification scenario, where outcomes
# were generated based on 12 hr exposure but 8 hour exposure is used. 
...
ls_1 <- list.files(
  here(
    ...
    "12_hrs_no_missingness_DID"
  ),
  pattern = "^outcome_data_12_hrs_no_missingness",
  full.names = T
)
...
saveRDS(
  ...
  here(
    ...
    "12_hr_outcome_models_beta_CIs_1p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "12_hr_outcome_models_beta_CIs_5p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "12_hr_outcome_models_beta_CIs_05p.RDS"
  )
)
...
colnames(results_cc_df_05) <-
  c(
    "beta_12_hr_outcome_model_05p_cc",
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "12_hr_outcome_models_case_crossover_beta_CIs_05p.RDS"
  )
)
...
colnames(results_cc_df_1) <-
  c(
    "beta_12_hr_outcome_model_1p_cc",
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "12_hr_outcome_models_case_crossover_beta_CIs_1p.RDS"
  )
)
...
colnames(results_cc_df_5) <-
  c(
    "beta_12_hr_outcome_model_5p_cc",
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "12_hr_outcome_models_case_crossover_beta_CIs_5p.RDS"
  )
)

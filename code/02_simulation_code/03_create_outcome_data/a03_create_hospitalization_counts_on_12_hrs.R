...
### scenario based on 12 hour outages. 
...
create_outcome_data <- function(i) {
  ...
  # 0.5
  lambda_0.5_p <-
    baseline_hosp_rate + effect_of_outage_0.5_p * exp1$exposed_under_12_hr_def
  ...
  # 1
  lambda_1_p <-
    baseline_hosp_rate + effect_of_outage_1_p * exp1$exposed_under_12_hr_def
  ...
  # 5
  lambda_5_p <-
    baseline_hosp_rate + effect_of_outage_5_p * exp1$exposed_under_12_hr_def
  ...
  saveRDS(
    ...
    here(
      ...
      paste0('outcome_data_12_hrs_no_missingness_', i, ".RDS")
    )
  )

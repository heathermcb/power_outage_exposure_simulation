...
# were generated based on 4 hr exposure but 8 hour exposure is used. 
...
ls_1 <- list.files(
  ...
  pattern = "^outcome_data_4_hrs_no_missingness",
  full.names = T
)
...
saveRDS(
  ...
  here(
    ...
    "4_hr_outcome_models_beta_CIs_1p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "4_hr_outcome_models_beta_CIs_5p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "4_hr_outcome_models_beta_CIs_05p.RDS"
  )
)
...
colnames(results_cc_df_05) <-
  c(
    "beta_4_hr_outcome_model_05p_cc",
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "4_hr_outcome_models_case_crossover_beta_CIs_05p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "4_hr_outcome_models_case_crossover_beta_CIs_1p.RDS"
  )
)
...
saveRDS(
  ...
  here(
    "power_outage_medicare",
    "simulation_model_output",
    "4_hr_outcome_models_case_crossover_beta_CIs_5p.RDS"
  )
)
